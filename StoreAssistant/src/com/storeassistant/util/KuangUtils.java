...
public class KuangUtils {
   ...
   * **/
	...
	/**
	   * method:�?��网络
	   * @param  activity
	   * @param  type 传入�?��int型的type�?则只是检测网�?没网时不会提�?
	   * return null;
	   * **/
 ...
 * @throws IOException 
  ...
  public String uploadByPost(Activity activity, String _url, String fileName,String id) 
  {
	 ...
	 *WebView加载<br>
	 *@param _activity 上下�?
	 *@param wv 传入的WebView控件
	 *@param content WebView加载的内�?
	 *@return null 
	 */
	...
	_activity.setProgressBarIndeterminateVisibility(true);// 设置标题栏的滚动条开�?
	...
	_activity.setProgressBarIndeterminateVisibility(false);// 设置标题滚动条停�?
	...
	new AlertDialog.Builder(_activity).setTitle("拨号").setItems(nums, listener1)
	...
	try {
		MessageDigest digest = MessageDigest.getInstance(codeType);// 获取�?��实例，并传入加密方式
		digest.reset();// 清空�?��
